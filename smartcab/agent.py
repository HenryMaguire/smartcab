...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = 0.99**self.time_step
            #self.epsilon -= 0.05
            #self.epsilon = (1+self.time_step)**(-2)
            self.time_step += 1
    ...
    def get_maxQ(self, state):
        ...
        for a, q in action_values.items():
            if q == maxQ:
                max_Q_actions.append(a)
        return maxQ, max_Q_actions
    ...
    def createQ(self, state):
        ...
        if self.learning:
            if state not in self.Q.keys():
                self.Q[state] = dict((action, 0.) for action in self.valid_actions)
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if np.random.random()< self.epsilon:
                ...
                pass
                maxQ, max_Q_actions = self.get_maxQ(state)
